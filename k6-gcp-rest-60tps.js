// K6 Load Test Script for GCP REST Endpoints - 60 TPS
...
export default function () {
  const payload = {
    id: `rest-60tps-${__VU}-${__ITER}`,
    content: `REST load test at 60 TPS - VU ${__VU} iteration ${__ITER}`,
...
export function handleSummary(data) {
  return { 'rest-60tps-results.json': JSON.stringify(data, null, 2) };
}
