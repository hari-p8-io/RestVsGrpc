...
export default () => {
  ...
  // Use proper protobuf timestamp format
  const data = {
    ...
    age: 30,
    created_date: {
      seconds: 1704067200, // 2024-01-01T00:00:00Z in seconds
      nanos: 0
    },
    updated_date: {
      seconds: 1704153600, // 2024-01-02T00:00:00Z in seconds  
      nanos: 0
    },
    birth_date: {
      seconds: 631152000, // 1990-01-01T00:00:00Z in seconds
      nanos: 0
    }
  };
