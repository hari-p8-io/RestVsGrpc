...
const ENDPOINT = '/api/benchmark/grpc/unary';

export default function () {
  const payload = {
    id: `grpc-unary-test-${__VU}-${__ITER}`,
    content: `gRPC unary load test message from VU ${__VU}, iteration ${__ITER}`,
...
export function handleSummary(data) {
  return {
    'grpc-unary-load-test-results.json': JSON.stringify(data, null, 2),
    stdout: `
========================================
gRPC UNARY CLIENT LOAD TEST RESULTS
========================================
