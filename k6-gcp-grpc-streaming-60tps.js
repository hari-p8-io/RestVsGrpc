// K6 Load Test Script for GCP gRPC Streaming Endpoints - 60 TPS
...
export default function () {
  const payload = {
    id: `grpc-streaming-60tps-${__VU}-${__ITER}`,
    content: `gRPC Streaming load test at 60 TPS - VU ${__VU} iteration ${__ITER}`,
...
export function handleSummary(data) {
  return { 'grpc-streaming-60tps-results.json': JSON.stringify(data, null, 2) };
}
